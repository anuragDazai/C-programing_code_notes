...
int main(){
    ...
    printf("%d \n", a); // this will print the value of a to the console, %d is a format specifier Format specifiers are used to tell the compiler how a value should be interpreted during input and output operations
